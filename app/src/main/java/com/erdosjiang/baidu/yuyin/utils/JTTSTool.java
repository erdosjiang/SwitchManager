...
import com.erdosjiang.baidu.yuyin.config.InitConfig;
import com.erdosjiang.baidu.yuyin.listener.JTTSListener;
...
public class JTTSTool {

    private static JTTSTool jttsTool;
     ...
     */
    protected String appId = "14809951";
    protected String appKey = "H0HkZc2wc5HgD2pBPYu8R1Yt";
    protected String secretKey = "nZwXOlC6hxt36eTY7H7nNZEGZZCEGQVD";
    ...
    public JTTSTool(Context context){
        initTTs(context);
    }
    ...
    private void initTTs(Context context) {
        ...
        SpeechSynthesizerListener listener = new JTTSListener();
    ...
    public static void initTTSTool(Context context){
        jttsTool = new JTTSTool(context);
    }
