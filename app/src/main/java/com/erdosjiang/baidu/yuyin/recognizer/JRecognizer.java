package com.erdosjiang.baidu.yuyin.recognizer;
...
/**
 * Created by erdosjiang@foxmail.com 20181116
 * 识别控制器
 */

public class JRecognizer {
    /**
     * SDK 内部核心 EventManager 类
     */
    private EventManager asr;

    // SDK 内部核心 事件回调类，识别回调逻辑
    ...
    private static final String TAG = "JRecognizer";
     ...
     */
    public JRecognizer(Context context, IRecogListener recogListener) {
     ...
     */
    public JRecognizer(Context context, EventListener eventListener) {
        if (isInited) {
